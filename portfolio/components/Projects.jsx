...
const projectData = [
  ...
  },
  {
    ...
    category: "MOBILE",
    name: "Nearby",
    description: "Coupons for places Nearby",
    github: "https://github.com/dhomini-rabelo/nlw-pocket",
  },
  {
    image: "/projects/movie.png",
    category: "FULLSTACK",
    name: "Movie Website",
    description: "Clean Arch & DDD Website",
  ...
  },
  {
    ...
    github:
      "https://github.com/dhomini-rabelo/Estudos-Ignite-React-003?tab=readme-ov-file#projeto-do-curso-feito-individualmente",
  },
  {
    ...
    github:
      "https://github.com/dhomini-rabelo/Estudos-Ignite-React-002?tab=readme-ov-file#projeto-do-curso-feito-individualmente",
  },
  {
...
const Projects = () => {
  ...
  return (
    <section id="projects" className="container mx-auto py-12 xl:py-24">
